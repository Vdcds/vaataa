...
export interface Donation {
  ...
  notes?: string; images: string[]; status: DonationStatus; createdAt: string; updatedAt: string; donorName?: string; donorType?: string;
}
...
export interface DonationDraft {
  title: string; category: FoodCategory; diet: FoodDiet; quantity: string; estimatedServings: string; preparedAt: string; storageMethod: string;
